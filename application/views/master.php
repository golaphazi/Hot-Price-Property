...
<html class="no-js"> <!--<![endif]-->
    ...
    <?php
        //$style = !empty($page_title) ? 'style="overflow: hidden;"' : '';
        $style = !empty($page_title) ? 'class="body-hidden"' : '';
     ?>
    ...
    <body <?= $style; ?> >
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer logo_hpp_footer">
                                ...
                                <ul class="footer-adress">
                                    <li><i class="pe-7s-map-marker strong"> </i>Suite 2, 13 Blackburn St, Maddington WA 6109</li>
                                    <li><i class="pe-7s-mail strong"> </i> <a href="mailto:sales@hotpriceproperty.com">sales@hotpriceproperty.com</a></li>
                                    <!--<li><i class="pe-7s-call strong"> </i>  <a href="tell:1800 552 163"> 0000 000 000</a></li> -->
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="<?= SITE_URL; ?>terms/">Legal </a></li> 
                                    <li><a href="<?= SITE_URL; ?>opt-out/">Opt out</a></li>
                                    <li><a href="<?= SITE_URL; ?>sitemap/">Site maps </a>  </li> 
                                    <li><a href="<?= SITE_URL; ?>careers/">Careers </a>  </li> 
                                    <li><a href="<?= SITE_URL; ?>find-agent/">Find an agent </a>  </li> 
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                                    ...
                                    ?>	
                                       <li>
                                        ...
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            ...
                                            <p style="line-height: 17px; padding: 8px 2px;"><?= substr(strip_tags(preg_replace('/style[^>]*/', '', htmlspecialchars_decode($news['PROPERTY_DESCRIPTION']))),0, 30);?> ...</p>
                                        </div>
                                    </li> 
                                    <?php
                                    endif;
                    ...
                    <div class="row">
                        ...
                        <div class="bottom-menu pull-right"> 
                            <ul> 
                                ...
                                <li><a class="wow fadeInUp animated" href="<?= SITE_URL; ?>property-news/" data-wow-delay="0.3s">Property news</a></li>
                                ...
                                <li><a class="wow fadeInUp animated" href="<?= SITE_URL; ?>help/" data-wow-delay="0.6s">Help</a></li>
                            </ul> 
                        </div>
                    </div>
                </div>
		...
		<script type="text/javascript">
			...
			_smartsupp.key = 'eda903671d6f2e98d923eabb8d98c82e3a193993';
        ...
        <script src="<?= JS_URL; ?>jquery.fadeCarousel.js"></script>
