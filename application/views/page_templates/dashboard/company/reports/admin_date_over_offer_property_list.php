    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">Date over property list</h1>               
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-9  pr0 padding-top-40 padd-bottom-70 properties-page">                    
                <div class="col-md-12 report_bottom"> 
                    <?= form_open('', [ 'id' => 'date_over_report', 'name' => 'date_over_report']); ?>   
                    <div class="col-sm-3">
                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>hpp/report/date_over_property_list?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>&user_type=<?= $user_type_id; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
                    ...
                    <div class="col-md-12 clear report_bottom"> 
                        <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : Date over property list (Offer)</strong></h5>
                        ...
                        <table class="table table-striped table-bordered datatable">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="center"> Offer Period </th>
										...
										foreach ($sellreport AS $report):
											if($countryId == $report['PROPERTY_COUNTRY']) { 
												...
												<tr>
													...
													<td class="center"> <?= date("d M Y H:i", strtotime($report['OFFER_START_DATE'])) . ' <b>to</b> ' .date("d M Y H:i", strtotime($report['OFFER_END_DATE'])); ?></td>
													<td class="right"> <?= number_format($report['OFFER_PRICE']); ?> <sup><?= $report['CURRENCY_SAMPLE']; ?></sup> </td>
												</tr>
												<?php
												$m++;
												$totalPrice += $report['PROPERTY_PRICE'];
												$totalSellPrice += $report['OFFER_PRICE'];
											}
											endforeach;
											 ?>
