        ...
        <div class="row">
            ...
            <div class="col-md-9  pr0 padding-top-40 properties-page">                    
                <div class="col-md-12 report_bottom"> 
                    <?= form_open('', [ 'id' => 'list_of_property', 'name' => 'list_of_property']); ?>   
                    <div class="col-sm-3">
                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>hpp/report/list_of_property?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>&user_type=<?= $user_type_id; ?>" target="_blank" title="PDF Download"> <i class="fa fa-file-pdf-o"></i></a>
            ...
            <?php } ?>
                <div id="print_start" class="row page">
                    <div class="col-md-12 clear report_bottom"> 
                        <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : List of property</strong></h5>
                    ...
                    <div class="col-xs-12 marT-10 border-top">
                        <?php
