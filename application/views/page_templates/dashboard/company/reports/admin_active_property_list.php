        ...
        <div class="row">
            ...
            <div class="col-md-9  pr0 padding-top-40 padd-bottom-70 properties-page">                    
                <div class="col-md-12 report_bottom"> 
                    <?= form_open('', [ 'id' => 'active_report', 'name' => 'active_report']); ?>   
                    <div class="col-sm-3">
                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>hpp/report/active_property_list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>&user_type=<?= $user_type_id; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
                        ...
                        <table class="table table-striped table-bordered datatable">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="center">Active Date </th>
