                ...
                <div class="col-md-12 padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>hpp/report/auction_win_property_list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
                    ...
                    <div class="col-md-12 report_bottom"> 
                        <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : Auction Win list of property </strong></h5>
                                <h5>Report Type : Auction Win Property</h5>
                                <?php
                                    if($user_type_id > 0){
									  ...
									  <tr>
										  <td colspan="8"> <center> <b><?= $country['countryName']; ?> (<?= $country['currency_code']; ?>)</b> </center> </td>
											...
											<tr>
												...
												<td class="right" colspan="3"> <b><?= number_format($totalPrice); ?></b> <sup><b><?= $country['currency_symbol']; ?></b></sup></td>
