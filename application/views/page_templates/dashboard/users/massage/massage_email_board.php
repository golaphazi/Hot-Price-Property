            ...
            <div class="container container_composeData">  
                <div class="row">
                        ...
                        <div class="col-md-12 clear"> 
                            ...
                            <div class="hpp_wpapper_table">
                                ...
                                <ul class="hpp-mailbox">
                                    <li class="<?php if($setUrl == 'all'){$nae = ''; echo 'active';}?>" ><a href="<?= SITE_URL ?>email-inbox?search=all">All <span class="count_massage"><?= $ALL_COUNT;?></span></a></li>
                                    <li class="<?php if($setUrl == 'inbox'){$nae = 'Inbox';  echo 'active';}?>" ><a href="<?= SITE_URL ?>email-inbox?search=inbox" >Inbox <span class="count_massage"><?= $ALL_COUNT_INbox;?></span></a></li>
                                    <li class="<?php if($setUrl == 'sent'){$nae = 'Sent';  echo 'active';}?>" ><a href="<?= SITE_URL ?>email-inbox?search=sent" >Sent <span class="count_massage"><?= $ALL_COUNT_SEND;?></span></a></li>
                                    <!--<li class="<?php if($setUrl == 'property'){$nae = 'Property';  echo 'active';}?>" ><a href="<?= SITE_URL ?>email-inbox?search=property" >Property </a></li>
                                    <li class="<?php if($setUrl == 'email'){$nae = 'Email';  echo 'active';}?>" ><a href="<?= SITE_URL ?>email-inbox?search=email" >Email </a></li> -->
				    <li class="compose" onclick="composeEmail();"> <a href="<?= SITE_URL ?>email-inbox?search=compose" >Compose </a></li>
                                    <li class="compose support" onclick="composeEmail();"> <a href="<?= SITE_URL ?>email-inbox?search=compose&get=support" >Support </a></li>
                                            ...
                                            if (is_array($massage_list) && sizeof($massage_list) > 0) {
                                                ...
                                                foreach ($massage_list as $email) :
                                                    ...
                                                    if (is_array($massageDetails) AND sizeof($massageDetails) > 0) {
                                                        ...
                                                        $TO_TYPE = $massageDetails[0]['TO_TYPE_D'];
                                                    }
                                                    ...
                                                    if ($TO_USER == $this->userID AND $TO_TYPE == 'User') {
                                             ...
                                             <?php  if( $GetEmailView != 'view' && $Getscau == 0 ){
					...
					?>        
                                            <tr class="<?= $unread; ?>">
                                                           ...
                                                           <!-- <td class="inbox-small-cells"><i class="fa fa-star"></i></td>-->
                                                            <td class="view-message  dont-show message-link">
                                                                ...
                                                                <?php } ?>
                                                                <?= $unreadT; ?>
                                                                <a href="<?= SITE_URL; ?>email-inbox?search=<?= $setUrl; ?>&view-email=view&scau=<?= $email['CONTACT_AGENT_ID']; ?>&scaud=<?= $contactSub; ?>"> 
                                                                    <?= substr(strip_tags($email['CONTACT_SUBJECT']), 0, 35); ?><?php if (strlen(strip_tags($email['CONTACT_SUBJECT'])) > 35) {
                                                                    echo '..';
                                                                } ?>
                                                                </a>
                                                            </td>
                                                            <td class="view-message message-link"> 
                                                                <?= $inbox; ?>
                                                                <a href="<?= SITE_URL; ?>email-inbox?search=<?= $setUrl; ?>&view-email=view&scau=<?= $email['CONTACT_AGENT_ID']; ?>&scaud=<?= $contactSub; ?>"> 
                                                                <?= substr(strip_tags($shoertTitle), 0, 25); ?><?php if (strlen(strip_tags($shoertTitle)) > 25) {
                                                                    echo '..';
                                                                } ?>
                                                                </a>
                                                            </td>
                                            ...
                                            <?php } ?>
                                                   ...
                                                   <tr>
                                                       <td colspan="4">
                                                            <div class="row marX-0"> 
                                                                <div class="col-md-8 pull-left hpp-email-body">
                                                                    <?php
                                                                    if ($detailsShow['FROM_USER'] == $this->userID AND $detailsShow['FROM_TYPE_D'] == 'User') {
                                                           ...
                                                           <div class="row" style="margin:1px;">
                                                               <div class="col-md-12 email-footer">
                                                                    <div class="footer-reply">
                                                                        ...
                                                                        <?php
                                                                        if ($apply == 'replay') {
                                                                            $urlAgent = SITE_URL . 'email-inbox?search=' . $setUrl . '&view-email=view&scau=' . $email['CONTACT_AGENT_ID'] . '&scaud=' . $detailsShow['CONTACT_AGENT_DETAILS_ID'] . '&apply=replay';
                                                                            ?>
                                                                            ...
                                                                            $urlAgent = SITE_URL . 'email-inbox?search=' . $setUrl . '&view-email=view&scau=' . $email['CONTACT_AGENT_ID'] . '&scaud=' . $detailsShow['CONTACT_AGENT_DETAILS_ID'] . '&apply=forward';
                                                                            ?>
                                                                            <?= form_open($urlAgent, ['id' => 'replay_form', 'name' => 'replay_form']); ?>
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <datalist id="compose_email_list1">
                                                                                            ...
                                                                                            foreach ($compose_email_list AS $list) {
                                                                                                ...
                                                                                                if ($list['FROM_USER'] == $this->userID) {
                                                                                                    $searchUser = $list['TO_USER'];
                                                                                                }
                                                                                                $userEmail = $this->user->select_user_mail($searchUser);
                                                                                                if (strlen($userEmail) > 0 AND $list['FROM_USER'] != $this->userID) {
                                                     ...
                                                     <?php
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td colspan="3" class="view-message  dont-show message-link"> <a href="<?= SITE_URL; ?>email-inbox?search=<?= $setUrl; ?>&view-email=view&scau=<?= $email['CONTACT_AGENT_ID']; ?>&scaud=<?= $detailsShow['CONTACT_AGENT_DETAILS_ID']; ?>"> <?= $detailsShow['MESSAGE_TITLE']; ?> </a> <?= $inboxMas; ?></td>
                                            ...
                                            echo '<tr><td colspan="4"> No email found..!<td></tr>';
                                        }
                                        ?>
                                    </tbody>
                                </table>				
                ...
                <?php if($get_search == 'compose'){
                    ...
                    if($get_support == 'support'){
                        $toEmailReadonly = 'readonly';
                        $extraUr = '&get=support';
                    }
                    ?>
                <div class="composeData">
                    <?= form_open('email-inbox?search=compose'.$extraUr, ['id' => 'compose_form', 'name' => 'compose_form']); ?>
                            ...
                            <div class="col-md-12" id="box_id">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input list="compose_email_list1" type="email" required="" class="form-control" name="compose_email" <?= $toEmailReadonly;?> placeholder="To email ..." value="<?= $composeEmail;?>">
                                        <datalist id="compose_email_list1">
                                        <?php
                                        foreach($compose_email_list AS $list){
                                                $searchUser = $list['FROM_USER'];
