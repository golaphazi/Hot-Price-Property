    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">Date over offer list</h1>               
            </div>
        </div>
    </div>
</div>
               ...
               <div class="col-md-12 clear padding-top-40 "> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>date-over-property-list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
         ...
         <?php } ?>
                <div id="print_start" class="row page">
                    <div class="col-md-12 clear report_bottom">
                        <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : Date over list of offer property</strong></h5>
					...
					<div style="clear:both;"> </div>
                        ...
                        <table class="table table-striped table-bordered datatable font13">
                            <thead>
                                <tr>
