    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">Active property History</h1>               
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-9  pr0 padding-top-40 padd-bottom-70 properties-page">                    
                <div class="col-md-12 clear report_bottom"> 
                    <?= form_open('', [ 'id' => 'active_property_report', 'name' => 'active_property_report']); ?>   
                    <div class="col-sm-3">
                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                           <div class="export-pdf text-right">
                               <a href="<?= SITE_URL; ?>ongoing-property-list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
                    ...
                    <div class="col-md-12 clear report_bottom"> 
                       <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : Active list of property</strong></h5>
