        ...
        <div class="row">
                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>rent-property-list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
         ...
         <?php } ?>    
                <div id="print_start" class="row page">
                    ...
                    <div class="col-md-12 clear padding-top-40"> 
                        <?php
                        if (is_array($rent_report) AND sizeof($rent_report) > 0) {
                            ?>
