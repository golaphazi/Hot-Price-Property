                ...
                <div class="col-md-12 clear padding-top-40"> 
                    <div class="company_header">
                        <div class="export-pdf text-right">
                            <a href="<?= SITE_URL; ?>sold-out-property-list/?pdf=Yes&from_date=<?= $fromdate;?>&to_date=<?= $todate;?>&type_search=<?= $type_search; ?>" target="_blank"> <i class="fa fa-file-pdf-o"></i></a>
                    ...
                    <div class="col-md-12 clear report_bottom"> 
                        <div class="company_header" style="position: relative;overflow: hidden;">
                            ...
                            <div class="header-info">
                                <h5><strong>Report Title : Sold out list of property</strong></h5>
										...
										endforeach;
										 ?>
											...
											<tr>
												...
												<td class="right" colspan="3" > <b><?= number_format($totalSellPrice); ?></b> <sup><b><?= $country['currency_symbol']; ?></b></sup></td>
