<!-- Footer area-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <img src="<?= SITE_URL;?>assets/img/footer-logo.png" alt="" class="wow pulse" data-wow-delay="1s">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="<?= SITE_URL;?>faq">fqa</a>  </li> 
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="<?= SITE_URL;?>assets/img/demo/small-proerty-2.jpg">
                                            </a>
        ...
        <script src="<?= JS_URL;?>modernizr-2.6.2.min.js"></script>
        ...
        <script src="<?= JS_URL;?>easypiechart.min.js"></script>
        <script src="<?= JS_URL;?>jquery.easypiechart.min.js"></script>
