        ...
        <table style="width:100%;border: none;border-spacing: 0; margin: 0; padding: 0; background:#fff !important; margin-top:10px;">
            <tbody>
                ...
                <tr style="width: 100%;height: 80px;border:none;border-bottom: 1px solid #e0d7d7;">
                    <td style="border: none;vertical-align: middle;">
                        ...
                        <div style="width: 50%;float: left;text-align: center;">
                            <a href="<?= SITE_URL; ?>bidding-summery?action=pay_now" target="_blank" style="margin:10px; padding:8px; background:transparent; color:#333; border: 1px solid #FFA500;text-decoration: none;" onMouseOver="this.style.color = '#fff', this.style.background = '#FDC600'" onMouseOut="this.style.color = '#333', this.style.background = 'transparent'"> Pay Now </a>
                            <a href="<?= SITE_URL; ?>bidding-summery/" target="_blank" style="margin:10px; padding:8px; background:transparent; color:#333;border: 1px solid #FFA500;text-decoration: none;" onMouseOver="this.style.color = '#fff', this.style.background = '#FDC600'" onMouseOut="this.style.color = '#333', this.style.background = 'transparent'"> Add solicitors / Settlement Agent </a>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="border: none;vertical-align: middle;padding: 35px 0 15px 0;">
                        <div style="font-size:32px;font-weight:700;color: #4d4d4d;text-align: center;">You have successfully won the <?= $name_type;?>... !</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="border: none;vertical-align: middle;">
                        <div style="font-size:14px;text-align:center;font-weight:normal;color: #777777;line-height: 21px;">
                            Below are detailed information about your <?= $name_type;?> :
                        </div>
                    </td>
                </tr>
            ...
            <center>
                <div style="width:100%;max-width:440px;font-weight:normal;font-size: 14px;line-height: 21px;color: #777777;text-align: left;border: 1px solid #e5e5e5; border-radius: 5px;padding: 12px 15px 15px;margin-top: 10px;margin-left: auto;margin-right: auto; display: inline-block;">
                    <span style="font-size: 20px;font-weight: 700;padding: 5px 0; color: #d27e04; line-height: 3em;text-decoration: underline;"><?= $name_type;?> Win Details : </span><br />
                    <span style="font-size: 16px;font-weight: 600;color:#d27e04; line-height: 2em;">Property Name : <?= $name;?> . </span> <br />
                    <span style="font-size: 16px;font-weight: 600;color:#d27e04; line-height: 2em;">Win Price : <b>$ <?= number_format($bid);?> </b> </span> <br />
                </div>
            </center>
        </td>
    </tr>
...
<center style="margin:0 auto;">
    ...
    <div style="width: 244px;display: inline-block;font-weight:normal;font-size: 14px;line-height: 32px;color: #777777;text-align: left;border: 1px solid #e5e5e5; border-radius: 5px;padding: 12px 15px 15px; margin-right: 15px;">
        <span style="font-size: 18px;font-weight: 700;padding: 5px 0; color: #4d4d4d;line-height: 1.3;">Property Address</span><br />
         <?= $address;?>
    </div>
    ...
    <div style="width: 287px;display: inline-block;font-weight:normal;font-size: 14px;line-height: 21px;color: #777777;text-align: left;border: 1px solid #e5e5e5; border-radius: 5px;padding: 12px 15px 15px;">
        <span style="font-size: 15px;font-weight: 700;padding: 5px 0; color: #4d4d4d;line-height: 1.3;">Start Date Of Bidding</span><br />
		 <b><?= date("D m, Y", strtotime($bid_date))?> </b><br />
	  <span style="font-size: 15px;font-weight: 700;padding: 5px 0; color: #4d4d4d;line-height: 1.3;">Last Date Of Bidding</span> <br />
		<?= date("D m, Y", strtotime($last_bid_date))?><br />
       <span style="font-size: 15px;font-weight: 700;padding: 5px 0; color: #4d4d4d;line-height: 1.3;">Win Date Of Bid</span> <br />
		<?= date("D m, Y")?> 
